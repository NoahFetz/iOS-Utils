...
public extension KeyboardRespondable {
    ...
    private func updateScrollViewFrame(for keyboardFrame: CGRect) {
        ...
        let convertedContentViewFrame = contentView.superview?.convert(contentView.frame, to: UIApplication.shared.keyWindow) ?? .zero
        ...
        contentView.contentInset = UIEdgeInsets(top: contentView.contentInset.top, left: contentView.contentInset.left, bottom: diff, right: contentView.contentInset.right)
    }
}
